...
function MiniGraph() {
  const nodes = [
    { x: 72,  y: 52,  r: 7,  c: "#818cf8" },
    { x: 148, y: 34,  r: 5,  c: "#818cf8" },
    { x: 210, y: 64,  r: 9,  c: "#34d399" },
    { x: 284, y: 42,  r: 5,  c: "#34d399" },
    { x: 156, y: 108, r: 11, c: "#f59e0b" },
    { x: 236, y: 126, r: 6,  c: "#f59e0b" },
    { x: 308, y: 98,  r: 5,  c: "#818cf8" },
    { x: 96,  y: 130, r: 7,  c: "#60a5fa" },
    { x: 360, y: 68,  r: 6,  c: "#34d399" },
    { x: 332, y: 148, r: 5,  c: "#60a5fa" },
    { x: 52,  y: 102, r: 4,  c: "#60a5fa" },
    { x: 400, y: 108, r: 5,  c: "#f59e0b" },
    { x: 192, y: 162, r: 4,  c: "#60a5fa" },
  ];
  const edges = [
